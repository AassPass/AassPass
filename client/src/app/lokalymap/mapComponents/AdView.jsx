...
const renderMetadata = (ad) => {
  ...
  switch (category) {
    case "DEALS_DISCOUNTS":
      entries.push(
        { key: "description", node: <Info label="Description" value={metadata.description} fullWidth /> },
        { key: "discount", node: <Info label="Discount" value={`${metadata.discountPercentage}%`} /> },
        { key: "terms", node: <Info label="Terms" value={metadata.terms} fullWidth /> },
        { key: "validTill", node: <Info label="Valid Till" value={formatDate(metadata.validTill)} /> }
      );
      break;
    case "EVENTS":
      entries.push(
        { key: "description", node: <Info label="Description" value={metadata.description} fullWidth /> },
        { key: "organizer", node: <Info label="Organizer" value={metadata.organizerName} /> },
        { key: "time", node: <Info label="Time" value={metadata.time} /> },
        { key: "rsvp", node: <Info label="RSVP" value={metadata.rsvp} /> },
        { key: "location", node: <Link label="Location" href={metadata.location} fullWidth /> }
      );
      break;
    case "SERVICES":
      entries.push(
        { key: "description", node: <Info label="Description" value={metadata.description} fullWidth /> },
        { key: "serviceType", node: <Info label="Service Type" value={metadata.serviceType} /> },
        { key: "contact", node: <Info label="Contact" value={metadata.contact} /> },
        { key: "radius", node: <Info label="Radius" value={`${metadata.radius} km`} /> }
      );
      break;
    case "PRODUCTS_FOR_SALE":
      entries.push(
        { key: "description", node: <Info label="Description" value={metadata.description} fullWidth /> },
        { key: "price", node: <Info label="Price" value={`₹${metadata.price}`} /> },
        { key: "available", node: <Info label="Available" value={metadata.quantityAvailable} /> },
        { key: "delivery", node: <Info label="Delivery" value={metadata.deliveryOption} /> },
        { key: "condition", node: <Info label="Condition" value={metadata.condition} /> }
      );
      break;
    case "JOB_OPENINGS":
      entries.push(
        { key: "jobDesc", node: <Info label="Job Description" value={metadata.jobDescription} fullWidth /> },
        { key: "jobType", node: <Info label="Type" value={metadata.jobType} /> },
        { key: "salary", node: <Info label="Salary" value={metadata.salary} /> },
        { key: "hours", node: <Info label="Hours" value={metadata.hours} /> },
        { key: "location", node: <Info label="Location" value={metadata.location} /> },
        { key: "qualifications", node: <Info label="Qualifications" value={metadata.qualifications} /> }
      );
      break;
    case "RENTALS_PROPERTIES":
      entries.push(
        { key: "description", node: <Info label="Description" value={metadata.description} fullWidth /> },
        { key: "size", node: <Info label="Size/Area" value={metadata.sizeOrArea} /> },
        { key: "rent", node: <Info label="Rent" value={`₹${metadata.rent}`} /> },
        { key: "availableFrom", node: <Info label="Available From" value={metadata.availableFrom} /> },
        { key: "amenities", node: <Info label="Amenities" value={metadata.amenities} /> },
        { key: "contact", node: <Info label="Contact" value={metadata.contact} /> }
      );
      break;
    case "ANNOUNCEMENTS":
      entries.push(
        { key: "description", node: <Info label="Description" value={metadata.description} fullWidth /> },
        { key: "type", node: <Info label="Type" value={metadata.announcementType} /> },
        { key: "importance", node: <Info label="Importance" value={metadata.importanceLevel} /> }
      );
      break;
    case "CONTESTS_GIVEAWAYS":
      entries.push(
        ...
        { key: "eligibility", node: <Info label="Eligibility" value={metadata.eligibility} /> },
        { key: "endDate", node: <Info label="End Date" value={metadata.endDate} /> },
        { key: "rules", node: <Info label="Rules" value={metadata.rules} fullWidth /> },
        { key: "winnerAnnouncement", node: <Info label="Winner Announcement" value={metadata.winnerAnnouncementDate} /> },
        { key: "participation", node: <Info label="Participation" value={metadata.participationRules} /> }
      );
      break;
    default:
      return null;
